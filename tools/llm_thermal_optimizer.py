...
"""
    ...
    def optimize_single(self, solution, nsga_algorithm, thermal_calculator):
        ...
        try:
            ...
            if not hasattr(current_solution, 'max_temp') or current_solution.max_temp is None:
                ...
                try:
                    ...
                    current_solution = thermal_calculator.calculate_thermal_distribution(current_solution)
                except Exception as e:
                    print(f"热分析失败: {str(e)}")
                    # 创建模拟的温度场数据
            ...
            try:
                ...
                try:
                    ...
                    modified_solution = thermal_calculator.calculate_thermal_distribution(modified_solution)
                except Exception as e:
    ...
    def visualize_optimization_history(self):
        ...
        plt.title("LLM Thermal Optimization History - Temperature Changes Across Iterations", fontsize=14)
        plt.xlabel("LLM Suggestion Round", fontsize=12)
        plt.ylabel("Highest Temprature (°C)", fontsize=12)
